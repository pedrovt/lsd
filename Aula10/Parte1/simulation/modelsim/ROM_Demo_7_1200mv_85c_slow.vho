...
-- Equation(s):
-- \inst|Mux1~0_combout\ = (\SW[3]~input_o\ & (!\SW[1]~input_o\ & !\SW[2]~input_o\))
...
-- Equation(s):
-- \inst|Mux2~0_combout\ = ((\SW[3]~input_o\ & !\SW[1]~input_o\)) # (!\SW[2]~input_o\)
...
-- Equation(s):
-- \inst|Mux3~0_combout\ = (\SW[3]~input_o\ & (!\SW[1]~input_o\ & \SW[2]~input_o\)) # (!\SW[3]~input_o\ & (\SW[1]~input_o\))
