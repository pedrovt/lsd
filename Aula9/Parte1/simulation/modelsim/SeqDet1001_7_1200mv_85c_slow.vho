...
SIGNAL \freqDiv|s_count~12_combout\ : std_logic;
...
SIGNAL \seqDet|pState~8_combout\ : std_logic;
SIGNAL \seqDet|pState.B~q\ : std_logic;
SIGNAL \seqDet|pState~7_combout\ : std_logic;
SIGNAL \seqDet|pState.C~q\ : std_logic;
SIGNAL \seqDet|pState~6_combout\ : std_logic;
...
-- Equation(s):
-- \freqDiv|s_count~10_combout\ = (\freqDiv|Add0~30_combout\ & !\freqDiv|Equal0~9_combout\)
...
-- Equation(s):
-- \freqDiv|s_count~4_combout\ = (\freqDiv|Add0~34_combout\ & !\freqDiv|Equal0~9_combout\)
...
-- Equation(s):
-- \freqDiv|s_count~9_combout\ = (!\freqDiv|Equal0~9_combout\ & \freqDiv|Add0~36_combout\)
...
-- Equation(s):
-- \freqDiv|s_count~3_combout\ = (\freqDiv|Add0~42_combout\ & !\freqDiv|Equal0~9_combout\)
...
-- Equation(s):
-- \freqDiv|s_count~2_combout\ = (\freqDiv|Add0~44_combout\ & !\freqDiv|Equal0~9_combout\)
...
-- Equation(s):
-- \freqDiv|s_count~8_combout\ = (\freqDiv|Add0~46_combout\ & !\freqDiv|Equal0~9_combout\)
...
-- Equation(s):
-- \freqDiv|Equal0~5_combout\ = (!\freqDiv|s_count\(20) & (!\freqDiv|s_count\(24) & (\freqDiv|s_count\(27) & \freqDiv|s_count\(23))))
...
PORT MAP (
	dataa => \freqDiv|s_count\(20),
	datab => \freqDiv|s_count\(24),
	datac => \freqDiv|s_count\(27),
	datad => \freqDiv|s_count\(23),
	combout => \freqDiv|Equal0~5_combout\);

-- Location: LCCOMB_X58_Y70_N28
\freqDiv|Equal0~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \freqDiv|Equal0~6_combout\ = (\freqDiv|s_count\(15) & (\freqDiv|s_count\(18) & (!\freqDiv|s_count\(14) & !\freqDiv|s_count\(16))))
...
-- Equation(s):
-- \freqDiv|s_count~6_combout\ = (!\freqDiv|Equal0~9_combout\ & \freqDiv|Add0~14_combout\)
...
\freqDiv|s_count~12\ : cycloneive_lcell_comb
-- Equation(s):
-- \freqDiv|s_count~12_combout\ = (\freqDiv|Add0~18_combout\ & !\freqDiv|Equal0~9_combout\)
...
-- pragma translate_on
PORT MAP (
	datac => \freqDiv|Add0~18_combout\,
	datad => \freqDiv|Equal0~9_combout\,
	combout => \freqDiv|s_count~12_combout\);
...
-- Equation(s):
-- \freqDiv|Equal0~7_combout\ = (\freqDiv|s_count\(13) & (!\freqDiv|s_count\(11) & (!\freqDiv|s_count\(8) & \freqDiv|s_count\(9))))
...
-- Equation(s):
-- \freqDiv|Equal0~8_combout\ = (\freqDiv|s_count\(6) & (\freqDiv|Equal0~5_combout\ & (\freqDiv|Equal0~6_combout\ & \freqDiv|Equal0~7_combout\)))
...
-- Equation(s):
-- \freqDiv|Equal0~10_combout\ = (\freqDiv|s_count\(0) & (\freqDiv|Equal0~4_combout\ & \freqDiv|s_count\(1)))
...
-- Equation(s):
-- \freqDiv|s_count~1_combout\ = (\freqDiv|Add0~50_combout\ & !\freqDiv|Equal0~9_combout\)
...
-- Equation(s):
-- \freqDiv|s_count~0_combout\ = (\freqDiv|Add0~52_combout\ & ((!\freqDiv|Equal0~10_combout\) # (!\freqDiv|Equal0~8_combout\)))
...
-- Equation(s):
-- \freqDiv|s_count~7_combout\ = (\freqDiv|Add0~54_combout\ & ((!\freqDiv|Equal0~10_combout\) # (!\freqDiv|Equal0~8_combout\)))
...
-- Equation(s):
-- \freqDiv|Equal0~0_combout\ = (!\freqDiv|s_count\(29) & (!\freqDiv|s_count\(28) & (\freqDiv|s_count\(26) & !\freqDiv|s_count\(30))))
...
PORT MAP (
	...
	datab => \freqDiv|s_count\(28),
	datac => \freqDiv|s_count\(26),
...
-- Equation(s):
-- \freqDiv|Equal0~1_combout\ = (\freqDiv|s_count\(25) & (\freqDiv|s_count\(22) & (!\freqDiv|s_count\(19) & \freqDiv|s_count\(21))))
...
PORT MAP (
	...
	datac => \freqDiv|s_count\(19),
	datad => \freqDiv|s_count\(21),
	combout => \freqDiv|Equal0~1_combout\);

-- Location: LCCOMB_X58_Y70_N14
\freqDiv|Equal0~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \freqDiv|Equal0~2_combout\ = (\freqDiv|s_count\(17) & (\freqDiv|s_count\(12) & (!\freqDiv|s_count\(7) & !\freqDiv|s_count\(10))))
...
-- Equation(s):
-- \freqDiv|Equal0~3_combout\ = (\freqDiv|s_count\(5) & (\freqDiv|s_count\(2) & (\freqDiv|s_count\(4) & \freqDiv|s_count\(3))))
...
-- Equation(s):
-- \freqDiv|Equal0~4_combout\ = (\freqDiv|Equal0~0_combout\ & (\freqDiv|Equal0~1_combout\ & (\freqDiv|Equal0~2_combout\ & \freqDiv|Equal0~3_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \freqDiv|Equal0~0_combout\,
...
-- Equation(s):
-- \freqDiv|Equal0~9_combout\ = (\freqDiv|s_count\(0) & (\freqDiv|s_count\(1) & (\freqDiv|Equal0~4_combout\ & \freqDiv|Equal0~8_combout\)))
...
-- Equation(s):
-- \freqDiv|s_count~5_combout\ = (!\freqDiv|Equal0~9_combout\ & \freqDiv|Add0~24_combout\)
...
-- Equation(s):
-- \freqDiv|s_count~11_combout\ = (\freqDiv|Add0~26_combout\ & !\freqDiv|Equal0~9_combout\)
...
-- Equation(s):
-- \freqDiv|Equal1~2_combout\ = (!\freqDiv|s_count\(13) & (\freqDiv|s_count\(11) & (\freqDiv|s_count\(8) & !\freqDiv|s_count\(9))))
...
-- Equation(s):
-- \freqDiv|Equal1~0_combout\ = (\freqDiv|s_count\(20) & (\freqDiv|s_count\(24) & (!\freqDiv|s_count\(27) & !\freqDiv|s_count\(23))))
...
-- Equation(s):
-- \freqDiv|Equal1~1_combout\ = (!\freqDiv|s_count\(15) & (!\freqDiv|s_count\(18) & (\freqDiv|s_count\(14) & \freqDiv|s_count\(16))))
...
-- Equation(s):
-- \freqDiv|Equal1~3_combout\ = (!\freqDiv|s_count\(6) & (\freqDiv|Equal1~2_combout\ & (\freqDiv|Equal1~0_combout\ & \freqDiv|Equal1~1_combout\)))
...
-- Equation(s):
-- \freqDiv|clkOut~0_combout\ = (\freqDiv|Equal0~9_combout\) # ((\freqDiv|clkOut~q\ & ((!\freqDiv|Equal0~10_combout\) # (!\freqDiv|Equal1~3_combout\))))
...
PORT MAP (
	...
	datab => \freqDiv|Equal1~3_combout\,
	datac => \freqDiv|Equal0~10_combout\,
	datad => \freqDiv|Equal0~9_combout\,
...
\seqDet|pState~8\ : cycloneive_lcell_comb
-- Equation(s):
-- \seqDet|pState~8_combout\ = (\SW[0]~input_o\ & \KEY[0]~input_o\)
...
PORT MAP (
	datac => \SW[0]~input_o\,
	datad => \KEY[0]~input_o\,
	combout => \seqDet|pState~8_combout\);
...
PORT MAP (
	...
	d => \seqDet|pState~8_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \seqDet|pState.B~q\);

-- Location: LCCOMB_X114_Y40_N16
\seqDet|pState~7\ : cycloneive_lcell_comb
-- Equation(s):
-- \seqDet|pState~7_combout\ = (\KEY[0]~input_o\ & (!\SW[0]~input_o\ & \seqDet|pState.B~q\))
...
PORT MAP (
	...
	combout => \seqDet|pState~7_combout\);
...
PORT MAP (
	clk => \freqDiv|clkOut~clkctrl_outclk\,
	d => \seqDet|pState~7_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \seqDet|pState.C~q\);

-- Location: LCCOMB_X114_Y40_N4
\seqDet|pState~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \seqDet|pState~6_combout\ = (\KEY[0]~input_o\ & (!\SW[0]~input_o\ & \seqDet|pState.C~q\))
...
PORT MAP (
	...
	combout => \seqDet|pState~6_combout\);
...
-- Equation(s):
-- \seqDet|yout~1_combout\ = (\SW[0]~input_o\ & \seqDet|pState.D~q\)
