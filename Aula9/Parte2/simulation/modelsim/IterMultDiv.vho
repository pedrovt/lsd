...
-- Equation(s):
-- \mult_core|control_unit|Selector10~0_combout\ = (\mult_core|control_unit|s_state.ST_BIT_TEST~q\ & (!\mult_core|control_unit|s_iterCnt\(0))) # (!\mult_core|control_unit|s_state.ST_BIT_TEST~q\ & (\mult_core|control_unit|s_iterCnt\(0) & 
...
-- Equation(s):
-- \mult_core|control_unit|Selector8~2_combout\ = (\mult_core|control_unit|s_state.ST_BIT_TEST~q\ & (\mult_core|control_unit|s_iterCnt\(2) $ (((\mult_core|control_unit|s_iterCnt\(0) & \mult_core|control_unit|s_iterCnt\(1))))))
...
PORT MAP (
	...
	datad => \mult_core|control_unit|s_iterCnt\(1),
...
-- Equation(s):
-- \mult_core|control_unit|Selector8~3_combout\ = (\mult_core|control_unit|Selector8~2_combout\) # ((!\mult_core|control_unit|s_state.ST_BIT_TEST~q\ & (\mult_core|control_unit|s_iterCnt\(2) & \mult_core|control_unit|s_state.ST_IDLE~q\)))
...
-- Equation(s):
-- \mult_core|control_unit|Selector1~0_combout\ = (\mult_core|control_unit|s_state.ST_INIT~q\) # ((\mult_core|control_unit|s_state.ST_SHIFT~q\ & !\mult_core|control_unit|s_iterCnt\(3)))
...
-- pragma translate_on
PORT MAP (
	dataa => \mult_core|control_unit|s_state.ST_SHIFT~q\,
...
-- Equation(s):
-- \mult_core|multiplier_reg|s_regData~7_combout\ = (!\s_globalReset~q\ & (s_operand1(7) & \mult_core|control_unit|regsInit~q\))
...
-- pragma translate_on
PORT MAP (
	dataa => \mult_core|control_unit|s_state.ST_INIT~q\,
	datab => \mult_core|control_unit|Selector9~0_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \mult_core|multiplier_reg|s_regData\(7),
	datac => \mult_core|control_unit|regsInit~q\,
	datad => s_operand1(6),
...
-- pragma translate_on
PORT MAP (
	dataa => \mult_core|multiplier_reg|s_regData\(5),
	datab => s_operand1(4),
	datac => \mult_core|control_unit|regsInit~q\,
...
-- pragma translate_on
PORT MAP (
	dataa => \mult_core|multiplier_reg|s_regData\(4),
	datac => \mult_core|control_unit|regsInit~q\,
	datad => s_operand1(3),
...
PORT MAP (
	dataa => s_operand1(0),
	datac => \mult_core|control_unit|regsInit~q\,
	datad => \mult_core|multiplier_reg|s_regData\(1),
...
-- Equation(s):
-- \mult_core|control_unit|s_state~13_combout\ = (\mult_core|control_unit|s_state.ST_BIT_TEST~q\ & (!\s_globalReset~q\ & \mult_core|multiplier_reg|s_regData\(0)))
...
-- Equation(s):
-- \mult_core|control_unit|Selector3~0_combout\ = (\mult_core|control_unit|s_state.ST_RES_ACC~q\) # ((\mult_core|control_unit|s_state.ST_BIT_TEST~q\ & !\mult_core|multiplier_reg|s_regData\(0)))
...
-- Equation(s):
-- \main_ctrl_unit|s_state~18_combout\ = (!\s_multDiv_n~q\ & (!\main_ctrl_unit|s_state.ST_IDLE~q\ & (!\s_globalReset~q\ & \s_start~q\)))
...
-- Equation(s):
-- \main_ctrl_unit|s_state~17_combout\ = (!\s_globalReset~q\ & \main_ctrl_unit|s_state.ST_DIV_START~q\)
...
PORT MAP (
	datac => \s_globalReset~q\,
	datad => \main_ctrl_unit|s_state.ST_DIV_START~q\,
...
-- Equation(s):
-- \main_ctrl_unit|s_state~14_combout\ = (!\main_ctrl_unit|s_state.ST_IDLE~q\ & (\s_multDiv_n~q\ & (!\s_globalReset~q\ & \s_start~q\)))
...
-- Equation(s):
-- \main_ctrl_unit|s_state~15_combout\ = (\main_ctrl_unit|s_state.ST_MULT_WAIT~q\ & (!\main_ctrl_unit|s_state.ST_DIV_WAIT~q\ & (!\mult_core|control_unit|done~q\ & !\main_ctrl_unit|s_state.ST_DIV_START~q\)))
...
-- Equation(s):
-- \main_ctrl_unit|s_state~13_combout\ = (!\main_ctrl_unit|s_state.ST_DIV_WAIT~q\ & (!\s_globalReset~q\ & !\main_ctrl_unit|s_state~12_combout\))
...
-- Equation(s):
-- \main_ctrl_unit|Selector5~0_combout\ = (\main_ctrl_unit|s_state.ST_IDLE~q\ & (((\main_ctrl_unit|multStart~q\)))) # (!\main_ctrl_unit|s_state.ST_IDLE~q\ & (\s_start~q\ & (\s_multDiv_n~q\ $ (\main_ctrl_unit|multStart~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \main_ctrl_unit|Selector5~0_combout\,
...
-- Equation(s):
-- \mult_core|control_unit|s_state~12_combout\ = (!\s_globalReset~q\ & (!\mult_core|control_unit|busy~0_combout\ & ((\mult_core|control_unit|s_state.ST_IDLE~q\) # (\main_ctrl_unit|multStart~q\))))
...
-- Equation(s):
-- \mult_core|control_unit|Selector6~0_combout\ = (\mult_core|control_unit|s_state.ST_IDLE~q\ & (!\mult_core|control_unit|s_state.ST_INIT~q\ & (\mult_core|control_unit|regsInit~q\))) # (!\mult_core|control_unit|s_state.ST_IDLE~q\ & 
-- (((\mult_core|control_unit|regsInit~q\) # (\main_ctrl_unit|multStart~q\))))
...
-- Equation(s):
-- \mult_core|result_acc|s_regData[4]~18_combout\ = (\s_globalReset~q\) # (\mult_core|control_unit|regsInit~q\)
...
-- Equation(s):
-- \mult_core|result_acc|s_regData[4]~19_combout\ = (\mult_core|control_unit|accEnable~q\) # ((\s_globalReset~q\) # (\mult_core|control_unit|regsInit~q\))
...
-- pragma translate_on
PORT MAP (
	datab => \mult_core|control_unit|accEnable~q\,
	datac => \s_globalReset~q\,
	datad => \mult_core|control_unit|regsInit~q\,
...
-- Equation(s):
-- \main_ctrl_unit|Selector7~1_combout\ = (\main_ctrl_unit|s_state.ST_MULT_START~q\) # ((\main_ctrl_unit|s_state.ST_MULT_WAIT~q\ & ((\main_ctrl_unit|multSel~q\) # (\mult_core|control_unit|done~q\))))
...
PORT MAP (
	...
	datad => \main_ctrl_unit|s_state.ST_MULT_START~q\,
	combout => \main_ctrl_unit|Selector7~1_combout\);

-- Location: LCCOMB_X103_Y41_N22
\main_ctrl_unit|Selector7~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \main_ctrl_unit|Selector7~2_combout\ = (\main_ctrl_unit|Selector7~0_combout\) # (\main_ctrl_unit|Selector7~1_combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \main_ctrl_unit|Selector7~0_combout\,
	datab => \main_ctrl_unit|Selector7~1_combout\,
...
PORT MAP (
	datac => \main_ctrl_unit|multSel~q\,
	datad => \mult_core|result_acc|s_regData\(1),
...
PORT MAP (
	datac => \main_ctrl_unit|multSel~q\,
	datad => \mult_core|result_acc|s_regData\(2),
...
PORT MAP (
	dataa => \mult_core|control_unit|regsInit~q\,
	datac => \mult_core|multiplicand_reg|s_regData\(3),
	datad => s_operand0(4),
...
-- Equation(s):
-- \LEDR~5_combout\ = (\mult_core|result_acc|s_regData\(5) & \main_ctrl_unit|multSel~q\)
...
-- Equation(s):
-- \LEDR~6_combout\ = (\mult_core|result_acc|s_regData\(6) & \main_ctrl_unit|multSel~q\)
...
-- pragma translate_on
PORT MAP (
	datac => \mult_core|result_acc|s_regData\(6),
	datad => \main_ctrl_unit|multSel~q\,
	combout => \LEDR~6_combout\);

-- Location: FF_X96_Y41_N19
\LEDR[6]~reg0\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
...
-- pragma translate_on
PORT MAP (
	dataa => \mult_core|multiplicand_reg|s_regData\(6),
	datac => \mult_core|control_unit|regsInit~q\,
	datad => s_operand0(7),
...
PORT MAP (
	dataa => \main_ctrl_unit|multSel~q\,
	datac => \mult_core|result_acc|s_regData\(7),
...
-- Equation(s):
-- \mult_core|multiplicand_reg|s_regData~9_combout\ = (\mult_core|multiplicand_reg|s_regData\(7) & (!\mult_core|control_unit|regsInit~q\ & !\s_globalReset~q\))
...
-- Equation(s):
-- \LEDR~9_combout\ = (\mult_core|result_acc|s_regData\(9) & \main_ctrl_unit|multSel~q\)
...
-- Equation(s):
-- \mult_core|multiplicand_reg|s_regData~11_combout\ = (\mult_core|multiplicand_reg|s_regData\(9) & (!\mult_core|control_unit|regsInit~q\ & !\s_globalReset~q\))
...
-- Equation(s):
-- \LEDR~10_combout\ = (\mult_core|result_acc|s_regData\(10) & \main_ctrl_unit|multSel~q\)
...
-- pragma translate_on
PORT MAP (
	datab => \mult_core|result_acc|s_regData\(10),
	datad => \main_ctrl_unit|multSel~q\,
...
-- Equation(s):
-- \mult_core|multiplicand_reg|s_regData~12_combout\ = (\mult_core|multiplicand_reg|s_regData\(10) & (!\mult_core|control_unit|regsInit~q\ & !\s_globalReset~q\))
...
-- pragma translate_on
PORT MAP (
	dataa => \mult_core|multiplicand_reg|s_regData\(10),
	datac => \mult_core|control_unit|regsInit~q\,
	datad => \s_globalReset~q\,
...
-- Equation(s):
-- \LEDR~11_combout\ = (\mult_core|result_acc|s_regData\(11) & \main_ctrl_unit|multSel~q\)
...
-- pragma translate_on
PORT MAP (
	datac => \mult_core|result_acc|s_regData\(11),
	datad => \main_ctrl_unit|multSel~q\,
...
-- Equation(s):
-- \mult_core|multiplicand_reg|s_regData~13_combout\ = (\mult_core|multiplicand_reg|s_regData\(11) & (!\mult_core|control_unit|regsInit~q\ & !\s_globalReset~q\))
...
-- Equation(s):
-- \LEDR~12_combout\ = (\mult_core|result_acc|s_regData\(12) & \main_ctrl_unit|multSel~q\)
...
-- pragma translate_on
PORT MAP (
	datac => \mult_core|result_acc|s_regData\(12),
	datad => \main_ctrl_unit|multSel~q\,
	combout => \LEDR~12_combout\);

-- Location: FF_X96_Y41_N11
\LEDR[12]~reg0\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
...
-- Equation(s):
-- \mult_core|multiplicand_reg|s_regData~14_combout\ = (\mult_core|multiplicand_reg|s_regData\(12) & (!\mult_core|control_unit|regsInit~q\ & !\s_globalReset~q\))
...
-- pragma translate_on
PORT MAP (
	datab => \mult_core|result_acc|s_regData\(13),
	datad => \main_ctrl_unit|multSel~q\,
...
-- Equation(s):
-- \mult_core|multiplicand_reg|s_regData~15_combout\ = (!\s_globalReset~q\ & (!\mult_core|control_unit|regsInit~q\ & \mult_core|multiplicand_reg|s_regData\(13)))
...
PORT MAP (
	dataa => \s_globalReset~q\,
	datac => \mult_core|control_unit|regsInit~q\,
	datad => \mult_core|multiplicand_reg|s_regData\(13),
...
-- Equation(s):
-- \LEDR~14_combout\ = (\mult_core|result_acc|s_regData\(14) & \main_ctrl_unit|multSel~q\)
...
-- Equation(s):
-- \mult_core|multiplicand_reg|s_regData~16_combout\ = (!\s_globalReset~q\ & (!\mult_core|control_unit|regsInit~q\ & \mult_core|multiplicand_reg|s_regData\(14)))
...
PORT MAP (
	dataa => \s_globalReset~q\,
	datac => \mult_core|control_unit|regsInit~q\,
	datad => \mult_core|multiplicand_reg|s_regData\(14),
...
-- Equation(s):
-- \LEDR~15_combout\ = (\mult_core|result_acc|s_regData\(15) & \main_ctrl_unit|multSel~q\)
